...
export class ChamadoDetalheDialogComponent {
  ...
  /** Extrai HH:mm de qualquer formato de data/hora */
  formatTime(d: any): string {
    ...
    // Qualquer string que contenha HH:mm (ex: "09/04/2026 - 23:08")
    const match = s.match(/(\d{2}:\d{2})/);
    return match ? match[1] : '';
  }

  /** Retorna data e hora combinados: dd/MM/yyyy - HH:mm (ou só a data se não houver hora) */
